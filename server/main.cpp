...
//   char buffer[1024];
//   while (true) {
//     int received_bytes = client->get_socket().receive(buffer,
//     sizeof(buffer)); if (received_bytes <= 0) {
//       break;
//     }
//
...
//       std::cerr << "Failed to send message back to client " <<
//       client->get_id()
//                 << std::endl;
//     }
//   }
...
int main() {
  ...
  //     std::cerr << "Failed to accept incoming client connection" <<
  //     std::endl; continue;
  //   }
  //
